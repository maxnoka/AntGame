...
Objects0=../build-$(ConfigurationName)/AntGame/foo.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/AntGame/main.cpp$(ObjectSuffix) ../build-$(ConfigurationName)/AntGame/bar.cpp$(ObjectSuffix) 
...
../build-$(ConfigurationName)/AntGame/bar.cpp$(ObjectSuffix): bar.cpp ../build-$(ConfigurationName)/AntGame/bar.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "D:/Ant/AntGame/AntGame/AntGame/bar.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/bar.cpp$(ObjectSuffix) $(IncludePath)
